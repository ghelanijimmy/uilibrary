...
<Canvas>
	...
	<Story name="Default XL Inverse" args={{text: `inverse`, type: DEFAULT, size: XL, inverse: true}}>
		{args => <Button {...args} />}
	</Story>
	<Story name="Primary LG" args={{text: PRIMARY, type: PRIMARY, size: LG}}>
		{args => <Button {...args} />}
	</Story>
	<Story name="Primary LG Inverse" args={{text: 'inverse', type: PRIMARY, size: LG, inverse: true}}>
		{args => <Button {...args} />}
	</Story>
	<Story name="Secondary SM" args={{text: SECONDARY, type: SECONDARY, size: SM}}>
		{args => <Button {...args} />}
	</Story>
	<Story name="Secondary SM Inverse" args={{text: 'inverse', type: SECONDARY, size: SM, inverse: true}}>
		{args => <Button {...args} />}
	</Story>
</Canvas>
