...
<Meta
  ...
  argTypes={{
    ...
    inverse: {
      ...
      type: "boolean",
      defaultValue: false,
      description: "Inverse of button type",
      table: {
        type: {
          summary: "Inverse of type",
          detail: "Render inverse colors of selected type",
        },
        defaultValue: false,
      },
    },
    handleClick: {
      ...
      table: {
        type: {
          summary: "onClick Handler for button",
          detail: "Handle the button onClick mouse event",
        },
        defaultValue: () => null,
      },
    },
    displayBlock: {
      ...
      table: {
        type: {
          summary: "Set display to block",
          detail: "Set CSS display property to block instead of inline-block",
        },
        defaultValue: false,
      },
    },
...
<Story name="Default Button">{DefaultButton}</Story>
...
<Canvas>
  <Story name="Default XL" args={{ text: DEFAULT, type: DEFAULT, size: XL }}>
    {(args) => <Button {...args} />}
  </Story>
  <Story
    name="Default XL Inverse"
    args={{ text: `inverse`, type: DEFAULT, size: XL, inverse: true }}
  >
    {(args) => <Button {...args} />}
  </Story>
  ...
  <Story
    name="Primary LG Inverse"
    args={{ text: "inverse", type: PRIMARY, size: LG, inverse: true }}
  >
    {(args) => <Button {...args} />}
  </Story>
  <Story
    name="Secondary SM"
    args={{ text: SECONDARY, type: SECONDARY, size: SM }}
  >
    {(args) => <Button {...args} />}
  </Story>
  <Story
    name="Secondary SM Inverse"
    args={{ text: "inverse", type: SECONDARY, size: SM, inverse: true }}
  >
    {(args) => <Button {...args} />}
  </Story>
</Canvas>
...
<ColorPalette>
  <ColorItem
    ...
    colors={["#333", "#a00000", "#0255d7"]}
  />
  <ColorItem
    title="Button BG Colors"
    subtitle="Hover state"
    colors={["#1d1d1d", "#ba1e1e", "#1d6de2"]}
  />
</ColorPalette>
